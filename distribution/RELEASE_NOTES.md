...
Known limits: mobile reminders refresh after foregrounding the app, no durable offline editing, physical-device notification checks remain required, and public support details/store enrollment are not yet complete. See the repository's `docs/STORE_SUBMISSION.md` for next steps.
